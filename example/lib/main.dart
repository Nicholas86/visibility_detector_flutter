...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Visibility Detector 示例'),
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDemoCard(
              ...
              description: '展示 VisibilityDetector 的基本用法和可见性分析',
            ...
            _buildDemoCard(
              ...
              description: '学习如何实现类似 RenderVisibilityDetector 的自定义组件',
              icon: Icons.code,
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const CustomRenderObjectDemoPage(),
                  ),
                );
              },
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'RenderVisibilityDetector 是一个透明的代理 RenderObject，'
                      '它通过监听绘制过程来收集变换矩阵和裁剪信息，'
                      '然后在合成阶段计算组件的实际可见性。'
                      '这种设计既不影响现有的布局结构，又能准确检测可见性变化。',
